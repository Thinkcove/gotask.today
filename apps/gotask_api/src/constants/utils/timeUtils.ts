...
// // Format total hours to "XdYhZm" format, always including minutes if days or hours are non-zero
...
//   let result = `${sign}${days}d${hours}h`;
//   // Always append minutes if days or hours are non-zero, otherwise omit for "0d0h"
//   result += days > 0 || hours > 0 ? `${minutes}m` : minutes > 0 ? `${minutes}m` : "";
//   return result;
// };
