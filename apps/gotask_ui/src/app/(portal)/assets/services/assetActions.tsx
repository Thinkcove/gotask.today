...
// const getAttributesById = async ([, id]: [string, string]) => {
...
// export const useAttributesById = (id: string) => {
//   const { data, error, isLoading } = useSWR([`fetchAttributesById`, id], getAttributesById, {
//     revalidateOnFocus: false
//   });
