...
export const TASK_WORKFLOW = {
  ...
  [TASK_STATUS.IN_REVIEW]: [TASK_STATUS.UNDER_REVIEW, TASK_STATUS.REVIEWED, TASK_STATUS.COMPLETED],
  [TASK_STATUS.UNDER_REVIEW]: [TASK_STATUS.REVIEWED, TASK_STATUS.COMPLETED],
  [TASK_STATUS.REVIEWED]: [
    TASK_STATUS.IN_PROGRESS,
    TASK_STATUS.HOLD,
    TASK_STATUS.NEED_INFO,
