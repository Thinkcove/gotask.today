...
import { storeTokens, isTokenExpired, fetchToken } from "../common/utils/authToken";
  ...
  const verifyOtp = async () => {
    ...
    try {
      ...
      if (res.ok && data.success && data.data) {
        ...
        // Store user and tokens based on rememberMe
        storeTokens(token, refreshToken, rememberMe, user);

        // Update user context with tokens
